...
export const projects = [
  ...
  { id: 'comparison', label: 'Подборка конкурентов', description: 'Концептил подборку объявлений конкурентов с их статистикой', video: '/projects/comparison.mp4', poster: '/projects/comparison.jpg' },
  { id: 'promotion', label: 'Таймлайн продвижения', description: 'Редизайнил отображение продвижения. Пользователям стало проще оценить влияние продвижения на результаты объявления', video: '/projects/timelines.mp4', poster: '/projects/timelines.jpg' },
